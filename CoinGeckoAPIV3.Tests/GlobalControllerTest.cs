// <copyright file="GlobalControllerTest.cs" company="APIMatic">
...
namespace CoinGeckoAPIV3.Tests
{
    ...
    /// </summary>
    [TestFixture]
    public class GlobalControllerTest : ControllerTestBase
    {
        /// <summary>
        ...
        {
            this.controller = this.Client.GlobalController;
        }
        ...
        [Test]
        public async Task TestTestGetcryptocurrencyglobaldata()
        {
            // Perform API call
            try
            {
                await this.controller.GetcryptocurrencyglobaldataAsync();
            }
            catch (ApiException)
            {
            }
